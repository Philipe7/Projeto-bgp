...
Topologia Implementada
    ...
    [AS 10]               |               [PIX BR-JP]
     R7 =====================================
  200.10.0.7        1.100.10.7     |    (VLAN 10 - Internet)
     |                            |    (VLAN 20 - Peering 20↔30)
     |                            |
  1.10.20.7                      |
     |                            |
     |                            |
    [AS 20 - Provedor Principal]   |    [AS 30]
         R3 ========================      R6
    1.10.20.3                           (Loopback peering)
         |                               
    iBGP Full-Mesh                      
    com Route Reflector                 
         |                               
    R1 ------ R2 ------ R4              
         10.20.12.0    10.20.42.0       
              |                         
         Filtros AS-Path               
         Local Preference              
              |                        
